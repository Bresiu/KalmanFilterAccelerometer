...
public class Complementary {
	...
	public SensorSingleData startProcess(SensorSingleData sensorSingleData) {
		...
		acceleration = new float[]{
				(float) sensorSingleData.getAccX(), (float) sensorSingleData.getAccY(),
				(float) sensorSingleData.getAccZ()};
		magnetic = new float[]{
				(float) sensorSingleData.getMagnX(), (float) sensorSingleData.getMagnY(),
				(float) sensorSingleData.getMagnZ()};
		gyroscope = new float[]{
				(float) sensorSingleData.getGyroX(), (float) sensorSingleData.getGyroY(),
